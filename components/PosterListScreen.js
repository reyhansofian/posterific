...
export default class PosterListScreen extends React.Component {
  ...
  renderUserIcon = () => {
    console.log('RENDER USER ICON')
    console.log(this.state);

    const result = {
      firstName: "Reyhan",
      id: "10210211448222589",
      profileImageUri: "https://scontent.xx.fbcdn.net/v/t1.0-1/p50x50/14724396_10207939362381863_8818036876666046244_n.jpg?oh=3a02779d7501ebc4a4217ee499997fb3&oe=59C872AC"
    }
    const user = new UserModel(result.id, result.firstName, result.profileImageUri);
    console.log('ANOTHERRR USEEER',user);
